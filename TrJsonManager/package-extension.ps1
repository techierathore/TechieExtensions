# PowerShell script to package the Techie JSON Manager extension for distribution

Write-Host "Packaging Techie JSON Manager Extension..." -ForegroundColor Green
...
$chromeOutput = ".\dist\TechieJsonManager-Chrome-Edge.zip"
Compress-Archive -Path $chromeSource -DestinationPath $chromeOutput -Force

# Package for Firefox (ZIP file)
Write-Host "Creating Firefox package..." -ForegroundColor Yellow
$firefoxOutput = ".\dist\TechieJsonManager-Firefox.zip"
