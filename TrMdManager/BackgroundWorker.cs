...
namespace TrMdManager
{
    public partial class BackgroundWorker : BackgroundWorkerBase
    {
        private static string? pendingMarkdownContent = null;
            ...
            try
            {
                    ...
                    actionProp.GetString() == "openEditor")
                {
                    ...
                    return new { success = true };
                         ...
                         action2.GetString() == "getMarkdownContent")
                {
                    // Return the pending content and clear it
                    var content = pendingMarkdownContent;
